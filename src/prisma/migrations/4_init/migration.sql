...
-- AddForeignKey
ALTER TABLE "prestadores" ADD CONSTRAINT "categoriaFk" FOREIGN KEY ("categoriaId") REFERENCES "categoriasServicos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "prestadores" ADD CONSTRAINT "userFK" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
