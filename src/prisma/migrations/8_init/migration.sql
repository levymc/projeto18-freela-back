...
-- AddForeignKey
ALTER TABLE "servicoSolicitado" ADD CONSTRAINT "categoriaFk" FOREIGN KEY ("categoriaId") REFERENCES "categoriasServicos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "servicoSolicitado" ADD CONSTRAINT "prestadorFk" FOREIGN KEY ("prestadorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "servicoSolicitado" ADD CONSTRAINT "solicitanteFk" FOREIGN KEY ("solicitanteId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
